 ...
 * out like any other. A request TYPED in a group is restated in that group alone: it was
 * stated to that group, and fanning it out bot-wide would publish it somewhere its author
 * never spoke (ADR 0008).
 */
